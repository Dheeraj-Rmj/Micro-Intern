...
const replacements = [
  ...
  {
    regex: /shadow-\[0_0_15px_rgba\(225,200,122,0\.15\)\]/g,
    replacement: "shadow-[0_4px_20px_rgba(37,99,235,0.15)]",
  },
  {
    regex: /shadow-\[0_0_30px_rgba\(225,200,122,0\.4\)\]/g,
    replacement: "shadow-[0_8px_30px_rgba(37,99,235,0.4)]",
  },
  ...
  {
    regex: /style=\{\{ color: 'rgba\(225, 224, 204, 0\.8\)' \}\}/g,
    replacement: 'style={{ color: "#64748b" }}',
  },
  {
    regex: /onMouseEnter=\{\(e\) => \(e\.currentTarget\.style\.color = '\#E1E0CC'\)\}/g,
    replacement: 'onMouseEnter={(e) => (e.currentTarget.style.color = "#0f172a")}',
  },
  {
    regex:
      /onMouseLeave=\{\(e\) => \(e\.currentTarget\.style\.color = 'rgba\(225, 224, 204, 0\.8\)'\)\}/g,
    replacement: 'onMouseLeave={(e) => (e.currentTarget.style.color = "#64748b")}',
  },
...
content = content.replace(
  /text-slate-900 font-normal"\n                  style=\{\{ fontFamily: "'Playfair Display', serif" \}\}\n                >\n                  Evaluate By Building.<br \/>\n                  <span className="italic" style=\{\{ color: "#2563eb" \}\}>Hire<\/span> By Code./g,
  'text-white font-normal"\n                  style={{ fontFamily: "\'Playfair Display\', serif" }}\n                >\n                  Evaluate By Building.<br />\n                  <span className="italic" style={{ color: "#2563eb" }}>Hire</span> By Code.',
);

// Fix the paragraph in the hero section to be white
content = content.replace(
  /className="text-blue-600\/90 font-bold text-xs sm:text-sm md:text-base leading-\[1\.4\] mb-6"/g,
  'className="text-white font-bold text-xs sm:text-sm md:text-base leading-[1.4] mb-6"',
);
