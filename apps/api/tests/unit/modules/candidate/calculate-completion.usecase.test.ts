...
describe('CalculateCompletionUseCase', () => {
  ...
  it('should compute full 100% completion when all criteria are satisfied', async () => {
    mockDb.candidateProfile.findUnique.mockResolvedValue({
      ...
      skills: [{ skill: 'TypeScript', level: 'EXPERT' }, { skill: 'Node.js', level: 'EXPERT' }, { skill: 'React', level: 'ADVANCED' }],
    ...
    mockDb.user.findUnique.mockResolvedValue({ id: 'user-1', avatarUrl: 'https://cdn.example.com/avatar.webp' });
