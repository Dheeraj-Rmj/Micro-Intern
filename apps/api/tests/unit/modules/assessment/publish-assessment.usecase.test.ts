...
import { AssessmentCannotPublishWithoutTasksError, AssessmentNotFoundError } from '@/modules/assessment/domain/errors/assessment.errors.js';
...
describe('PublishAssessmentUseCase', () => {
  ...
  beforeEach(() => {
    mockAssessmentRepo = {
      ...
      publish: vi.fn().mockImplementation(async (id, publishedAt) => {
        ...
        return new Assessment(t.id, t.companyId, t.createdById, AssessmentStatus.PUBLISHED, t.title, t.slug, t.description, t.instructions, t.skillsRequired, t.roleTitle, t.level, t.durationMinutes, t.passingScore, t.maxAttempts, t.isPublic, publishedAt, null, t.createdAt, new Date(), t.tasks);
      }),
    };
    mockCompanyRepo = {
  ...
  it('should reject publishing attempt with AssessmentCannotPublishWithoutTasksError when assessment has zero tasks', async () => {
    ...
    await expect(useCase.execute('user-owner', 'assessment-10')).rejects.toThrow(AssessmentCannotPublishWithoutTasksError);
