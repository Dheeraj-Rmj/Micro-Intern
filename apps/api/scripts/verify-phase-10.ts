...
async function main() {
  ...
  const envVars = ['SLACK_BOT_TOKEN', 'SLACK_CHANNEL_ID', 'SLACK_SIGNING_SECRET', 'WEBHOOK_SECRET', 'OPENAI_API_KEY', 'GROQ_API_KEY'];
  ...
  try {
    ...
    await webhookService.dispatch('123e4567-e89b-12d3-a456-426614174000', 'CANDIDATE_HIRED', { test: true });
