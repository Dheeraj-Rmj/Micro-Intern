...
export function createCompanyRouter(): Router {
  ...
  try {
    ...
    container.register(
      "GetDepartmentsUseCase",
      () => new GetDepartmentsUseCase(container.get("ICompanyRepository")),
    );
    container.register(
      "GetHiringAnalyticsUseCase",
      () => new GetHiringAnalyticsUseCase(container.get("ICompanyRepository")),
    );
    container.register(
      "GetBillingUseCase",
      () => new GetBillingUseCase(container.get("ICompanyRepository")),
    );
    container.register(
      "GetAIInsightsUseCase",
      () => new GetAIInsightsUseCase(container.get("ICompanyRepository")),
    );
    container.register(
      "ListCompanySubmissionsUseCase",
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER]) as RequestHandler,
    (req, res, next) => {
      controller.listSubmissions(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER]) as RequestHandler,
    (req, res, next) => {
      controller.getDepartments(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER]) as RequestHandler,
    (req, res, next) => {
      controller.getHiringAnalytics(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireRole(Role.COMPANY_OWNER) as RequestHandler,
    (req, res, next) => {
      controller.getBilling(req, res, next).catch(next);
    },
  );
