...
export interface ILearningOutcomeService {
  ...
  setOutcomes(assessmentId: string, descriptions: string[], isAiGenerated?: boolean): Promise<any[]>;
  generateAIOutcomes(assessmentId: string, roleTitle: string, description: string): Promise<string[]>;
}
