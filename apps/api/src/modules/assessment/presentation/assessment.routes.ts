...
export function registerAssessmentModuleDependencies(): void {
  ...
  try {
    ...
    container.register(
      ...
      (_infra: InfrastructureDependencies) => new PrismaAssessmentRepository(_infra.db),
    );
    container.register(
    ...
    container.register(
      "ListCompanyAssessmentsUseCase",
      () =>
        new ListCompanyAssessmentsUseCase(
          container.get("IAssessmentRepository"),
          container.get("ICompanyRepository"),
        ),
    );
    container.register(
      "ListPublicAssessmentsUseCase",
      () => new ListPublicAssessmentsUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "GetAssessmentDetailsUseCase",
      () =>
        new GetAssessmentDetailsUseCase(
          container.get("IAssessmentRepository"),
          container.get("ICompanyRepository"),
        ),
    );
    container.register(
      ...
      () => new DuplicateAssessmentUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "ArchiveAssessmentUseCase",
      () => new ArchiveAssessmentUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "DeleteAssessmentUseCase",
      () => new DeleteAssessmentUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "CreateAssessmentVersionUseCase",
      () => new CreateAssessmentVersionUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "ListAssessmentVersionsUseCase",
      () => new ListAssessmentVersionsUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "RestoreAssessmentVersionUseCase",
      () => new RestoreAssessmentVersionUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "SaveAsTemplateUseCase",
      () => new SaveAsTemplateUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "ListTemplatesUseCase",
      () => new ListTemplatesUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "GetAssessmentAnalyticsUseCase",
      () => new GetAssessmentAnalyticsUseCase(container.get("IAssessmentRepository")),
    );
    container.register(
      "GenerateMicroTasksUseCase",
      () =>
        new GenerateMicroTasksUseCase(
...
export function createAssessmentRouter(): Router {
  ...
  router.get(
    ...
    (req, res, next) => {
      controller.listTemplates(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    (req, res, next) => {
      controller.createAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.get("/", validate("query", ListPublicAssessmentsQuerySchema), (req, res, next) => {
    controller.listPublicAssessments(req, res, next).catch(next);
  });
  ...
  router.get(
    ...
    optionalAuthMiddleware as unknown as RequestHandler,
    (req, res, next) => {
      controller.getAssessmentDetails(req, res, next).catch(next);
    },
  );
  ...
  router.put(
    ...
    (req, res, next) => {
      controller.updateAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    audit(AuditAction.UPDATE, "Assessment") as RequestHandler,
    (req, res, next) => {
      controller.publishAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    audit(AuditAction.CREATE, "Assessment") as RequestHandler,
    (req, res, next) => {
      controller.duplicateAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    audit(AuditAction.UPDATE, "Assessment") as RequestHandler,
    (req, res, next) => {
      controller.archiveAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.delete(
    ...
    (req, res, next) => {
      controller.deleteAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER]) as RequestHandler,
    (req, res, next) => {
      controller.validateAssessment(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    (req, res, next) => {
      controller.triggerAIJob(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    (req, res, next) => {
      controller.createVersion(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER]) as RequestHandler,
    (req, res, next) => {
      controller.listVersions(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    (req, res, next) => {
      controller.restoreVersion(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    (req, res, next) => {
      controller.saveAsTemplate(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER]) as RequestHandler,
    (req, res, next) => {
      controller.getAnalytics(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    (req, res, next) => {
      controller.getCompetencyMatrix(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.mapCompetency(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.listLearningOutcomes(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.updateLearningOutcomes(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.generateLearningOutcomes(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.getTimeline(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.listResources(req, res, next).catch(next);
    },
  );
  ...
  router.post(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.createResource(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    authMiddleware as RequestHandler,
    (req, res, next) => {
      controller.listFeatureFlags(req, res, next).catch(next);
    },
  );
  ...
  router.get(
    ...
    requireAnyRole([Role.COMPANY_OWNER, Role.RECRUITER, Role.ADMIN]) as RequestHandler,
    (req, res, next) => {
      controller.getAIUsageAnalytics(req, res, next).catch(next);
    },
  );
