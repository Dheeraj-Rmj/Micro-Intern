          ...
          <div className="flex-1 flex flex-col justify-end gap-2">
            {[
              ...
              },
              {
                ...
                count: 850,
                width: "50%",
                color: "bg-amber-200 dark:bg-amber-500/20",
              },
              {
                stage: "Interviewed",
                count: 420,
              ...
              },
              {
                ...
                count: 342,
                width: "15%",
                color: "bg-emerald-200 dark:bg-emerald-500/20",
              },
            ].map((bar, i) => (
              <div key={i} className="flex items-center gap-4">
                <div className="w-24 text-right text-xs font-mono text-black/60 dark:text-white/60">
                  {bar.stage}
                </div>
