...
import { User, ShieldCheck, Save, Key } from "lucide-react";
...
export const SuperAdminProfilePage: React.FC = () => {
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <Breadcrumbs items={[{ label: "Admin Portal" }, { label: "My Profile" }]} />
      ...
      <div className="bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 rounded-[32px] p-8 shadow-sm">
        <div className="flex items-center gap-6 mb-8 pb-8 border-b border-black/5 dark:border-white/10">
          <div className="w-24 h-24 rounded-full bg-amber-500 text-black flex items-center justify-center text-4xl font-black shadow-lg">
          ...
          <div>
            ...
            <p className="text-black/50 dark:text-white/50 flex items-center gap-2">
              <User className="w-4 h-4" />
              {userProfile.email}
            </p>
            <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 text-xs font-bold uppercase tracking-wider">
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-2xl bg-black/5 dark:bg-white/5 border border-transparent focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm text-black dark:text-white"
                placeholder="••••••••"
              />
            </div>
            <div>
