...
export const SignUpPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="pt-1 pb-1">
            <label className={`flex items-start gap-2.5 cursor-pointer text-xs ${isDark ? 'text-white/60' : 'text-[#555555]'}`}>
              <input
                type="checkbox"
      ...
      {showTermsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in" onClick={() => setShowTermsModal(false)}>
          ...
          >
            <div className={`flex items-center justify-between px-7 py-5 border-b ${isDark ? 'border-white/10' : 'border-[#E8E4D8]'}`}>
            ...
            <div className="overflow-y-auto px-7 py-5 text-sm leading-relaxed space-y-4">
              ...
              {[
                { title: '1. Acceptance of Terms', body: 'By registering on MicroIntern, you agree to be bound by these Terms of Service. MicroIntern provides a platform connecting students and early-career candidates with companies offering short-form skill trials and internship opportunities.' },
                { title: '2. Eligibility', body: 'You must be at least 16 years old to use MicroIntern. By registering, you confirm that you are eligible and that all information you provide is accurate and truthful.' },
                { title: '3. Skill Trials', body: 'Trials posted on MicroIntern are real, company-issued briefs. Completion does not guarantee employment or payment unless explicitly stated by the company. MicroIntern facilitates the connection but is not a party to any hiring agreement.' },
                { title: '4. Account Responsibility', body: 'You are responsible for maintaining the security of your account. You must not share credentials or impersonate others. MicroIntern reserves the right to suspend or terminate accounts that violate these terms.' },
                { title: '5. Intellectual Property', body: 'Work submitted during trials may be reviewed by the posting company. Unless explicitly agreed otherwise, you retain ownership of your submissions.' },
                { title: '6. Prohibited Conduct', body: 'You may not use MicroIntern to submit fraudulent work, scrape data, spam other users, or engage in any activity that disrupts the platform or harms other users.' },
                { title: '7. Changes to Terms', body: 'MicroIntern may update these Terms at any time. Continued use of the platform after changes constitutes acceptance of the new terms.' },
              ].map((s) => (
                <div key={s.title}>
            ...
            <div className={`px-7 py-4 border-t ${isDark ? 'border-white/10' : 'border-[#E8E4D8]'}`}>
              <button
                onClick={() => setShowTermsModal(false)}
