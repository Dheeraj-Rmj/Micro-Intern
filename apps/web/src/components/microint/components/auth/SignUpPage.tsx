...
export const SignUpPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Account Created! 🎉", "Welcome to MicroIntern. Please verify your email.", "success");
      setCurrentRoute("dashboard");
    } catch (err: any) {
      let errorMessage = err.response?.data?.error?.message || err.message || "Could not create your account.";
