              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-black/5 dark:bg-white/5 text-black/40 dark:text-white/60">
                      Applied {app.appliedDate}
                    </span>
                  </div>

                  <h3 className="text-2xl tracking-tight font-serif text-black dark:text-white leading-tight">
                    {app.trialTitle}
                  </h3>
