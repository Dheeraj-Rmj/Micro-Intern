  ...
  if (!trial) {
    return (
      <div className="pb-12 text-black dark:text-white max-w-[1200px] mx-auto w-full font-sans">
        ...
        <div className="py-24 px-6 text-center rounded-[40px] bg-white dark:bg-[#0A0A0A] shadow-sm border border-black/5 dark:border-white/10 max-w-lg mx-auto my-10">
  ...
  return (
    <div className="pb-12 text-black dark:text-white max-w-[1200px] mx-auto w-full font-sans">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-6 mt-4">
        ...
        {/* Timer Widget */}
        <div className="flex items-center gap-4 bg-white dark:bg-[#0A0A0A] shadow-sm px-6 py-4 rounded-full border border-black/5 dark:border-white/10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-6">
          {/* Instructions Card */}
          <div className="p-8 rounded-[40px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-sm space-y-6">
            <h3 className="font-serif text-2xl tracking-tight text-black dark:text-white pb-4 border-b border-black/5 dark:border-white/10 flex items-center gap-3">
              <FileCode className="w-5 h-5 text-black dark:text-white" />
              Trial Scope
            </h3>

            <p className="text-sm text-black/60 dark:text-white/70 leading-relaxed font-medium">
              {trial.description}
            </p>

            <div>
              <h4 className="font-bold text-xs uppercase tracking-widest text-black/40 dark:text-white/50 mb-4">
          ...
          <div className="p-8 rounded-[40px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-sm space-y-6">
            <h3 className="font-serif tracking-tight text-xl flex items-center justify-between text-black dark:text-white">
              <span className="flex items-center gap-3">
                <Upload className="w-5 h-5" />
                Upload Files
              </span>
              <span className="text-[10px] font-bold px-2.5 py-1 rounded-md bg-black/5 dark:bg-white/5 text-black/40 dark:text-white/50 tracking-widest uppercase">
                {uploadedFiles.length} Attached
              </span>
            </h3>

            <label className="border-2 border-dashed border-black/10 dark:border-white/10 rounded-[24px] p-8 text-center flex flex-col items-center justify-center cursor-pointer hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="p-8 rounded-[40px] bg-white dark:bg-[#0A0A0A] border border-black/5 dark:border-white/10 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <h4 className="font-serif tracking-tight text-xl text-black dark:text-white">
                Ready for Evaluation?
              </h4>
              <p className="text-xs text-black/50 dark:text-white/60 mt-1 font-medium">
