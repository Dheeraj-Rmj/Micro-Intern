    ...
    <div className="max-w-6xl mx-auto py-6 px-4 space-y-6">
            ...
            <div className="bg-white dark:bg-[#0A0A0A] p-4 rounded-2xl border border-black/5 dark:border-white/10 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 rounded-xl bg-black/5 dark:bg-white/5 border border-black/5 text-xs text-black dark:text-white focus:outline-none"
                />
                {searchQuery && (
                  <button
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-black/5 dark:border-white/10">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 rounded-full bg-black/5 dark:bg-white/10 text-black/70 dark:text-white/70 text-xs font-semibold hover:bg-black/10 transition-colors flex items-center gap-1"
                  >
                    ...
                    >
                      ...
                      {post.githubRepoUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="flex items-center justify-between p-3.5 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 hover:border-purple-500/40 transition-colors"
                        >
                      ...
                      <div className="flex items-center justify-between text-xs text-black/50 dark:text-white/50 pt-3 border-t border-black/5 dark:border-white/10">
                        ...
                        <div className="pt-3 border-t border-black/5 dark:border-white/10 space-y-3">
                          {post.comments.map((c) => (
                            ...
                            >
                              ...
                              <p className="text-xs text-black/80 dark:text-white/80">{c.text}</p>
                            </div>
                          ))}
                ...
                {peers.map((peer) => (
                  ...
                  >
                    ...
                    <div className="space-y-1.5">
                      <span className="text-[10px] font-bold uppercase tracking-wider text-black/40 dark:text-white/40 block">
      ...
      {selectedPublicPeer && (
        ...
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="w-full max-w-2xl bg-white dark:bg-[#141414] rounded-[36px] border border-black/10 dark:border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-scale-up"
          >
            {/* Top Cover Banner */}
            ...
            <div className="p-6 sm:p-8 flex-1 overflow-y-auto space-y-6 -mt-14 relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div className="flex items-end gap-4">
                  <img
                    ...
                    className="w-24 h-24 sm:w-28 sm:h-28 rounded-full object-cover border-4 border-white dark:border-[#141414] shadow-lg bg-white"
                  />
                  <div>
                    <div className="flex items-center gap-2">
              ...
              {/* About Bio */}
              <div className="p-5 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 space-y-2">
                <h4 className="text-xs font-bold uppercase tracking-wider text-black/40 dark:text-white/40 flex items-center gap-1.5">
      ...
      {activeChatPeer && (
        ...
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="w-full sm:max-w-lg bg-white dark:bg-[#141414] rounded-t-[32px] sm:rounded-[32px] border border-black/10 dark:border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-scale-up"
          >
            {/* Chat Header */}
            <div className="p-4 sm:p-5 border-b border-black/10 dark:border-white/10 flex items-center justify-between bg-black/5 dark:bg-white/5">
              <div
                onClick={() => {
              ...
              <button
                type="button"
                onClick={() => setActiveChatPeer(null)}
                className="w-9 h-9 rounded-full bg-black/5 dark:bg-white/10 flex items-center justify-center hover:bg-black/10 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            {/* Chat Input Bar */}
            <div className="p-4 border-t border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 flex items-center gap-2">
              <input
                type="text"
                value={chatInput}
