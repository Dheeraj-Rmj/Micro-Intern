    ...
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-[--color-muted-foreground]">
          Sign in to your MicroIntern account
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <a
          ...
          className="flex items-center justify-center gap-2 rounded-lg border border-[--color-border] bg-[--color-card] px-4 py-2.5 text-sm font-medium text-[--color-foreground-default] transition-all hover:bg-[--color-muted] hover:shadow-[--shadow-sm]"
        >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-[--color-background-default] px-2 text-[--color-muted-foreground]">
      ...
      <form onSubmit={(e) => { void handleSubmit(onSubmit)(e); }} className="space-y-4" noValidate>
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-xs text-[oklch(0.55_0.24_264)] hover:underline"
          >
            Forgot password?
          </Link>
        </div>
