  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Authenticating...</h2>
        <p className="text-gray-500 mt-2">Securely logging you in. Please wait a moment.</p>
      </motion.div>
    </div>
  );
}
