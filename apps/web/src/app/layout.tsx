  ...
  return (
    <html lang="en" suppressHydrationWarning className={inter.variable}>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Almarai:wght@300;400;700;800&family=Instrument+Serif:ital@1&family=Playfair+Display:wght@400;600;700;800;900&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
