...
files.forEach(file => {
  ...
  content = content.replace(/text-black dark:text-white font-semibold/g, 'text-white dark:text-black font-semibold');
  content = content.replace(/text-black font-bold py-3.5/g, 'text-white dark:text-black font-bold py-3.5');
