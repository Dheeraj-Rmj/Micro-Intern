  ...
  const insights = [
    {
      ...
      description:
        "Your open Engineering roles have a 40% candidate drop-off rate when assessing advanced Next.js concepts. Consider adjusting the assessment difficulty or providing study materials.",
      severity: "Medium",
    ...
    },
    {
      ...
      description:
        "The offer acceptance rate for Senior Backend Engineers has dropped by 15% this quarter. Market data suggests your current compensation band is 10% below the industry average.",
      severity: "High",
    ...
    },
    {
      ...
      description:
        "Referrals currently yield the highest offer acceptance rate (92%) and lowest time-to-hire (10 days). We recommend launching an internal referral campaign to boost this channel.",
      severity: "Low",
